/*
Package auth implements the one-time password algorithms supported by Google Authenticator
...
//
// https://code.google.com/p/google-authenticator/wiki/ConflictingAccountsee h
